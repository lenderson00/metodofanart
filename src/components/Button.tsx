...
export const ButtonFixed: React.FC<Props> = ({ isVisible }) => {
  ...
  return (
    <AnimatePresence initial={false}> {isVisible && <motion.div className='fixed bottom-0   left-0 right-0 px-[5vw] sm:px-0 '
...
s
    ...
    <div className='  font-semibold bg-[#f9f5f1]'>
      <div className='container mx-auto max-w-5xl flex flex-row pb-8 pt-4'>
      <h1>
